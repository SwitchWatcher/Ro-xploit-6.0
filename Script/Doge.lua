...
if hum then
	if hum:FindFirstChild("Animator") then
		hum:FindFirstChild("Animator"):Remove()
	end
end
if anim then
anim:Destroy()
...
local controller = controllerService:GetChildren()[1]
	...
	SFX.SoundId = "rbxassetid://187873574"
mouse.KeyDown:connect(function(k)
	...
	local pl = SFX:Clone()
	pl.Volume = 1
	pl.Pitch=(math.random(95,105)*0.01);
	pl.Parent = plr.Character.Head
	pl:Play()
	game.Debris:AddItem(pl,3)
    end
    if k == "z" then
